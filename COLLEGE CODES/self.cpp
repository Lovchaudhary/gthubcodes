...
void getdata(int a,int b) {
    ...
    void finder() {
        char task;
        cout<<"what do you wana do : for power/ exponential press ^, for  log press 'l' and for  sqrt press 's' and for trigonemetric funstiopns press 't'"<<endl;
        cin>>task;
        switch (task) {
            case '^':
